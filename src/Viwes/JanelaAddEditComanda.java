 ...
 * @author andre
 */
public class JanelaAddEditComanda extends javax.swing.JFrame {
    private Produtos Produto;
    /**
     * Creates new form JanelaAddProdutoComanda
     */
    public JanelaAddEditComanda( Produtos Produto) {
    ...
    private void IncluirBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IncluirBtnActionPerformed
          ...
          JOptionPane.showMessageDialog(this, "Estoque insuficiente", "Ops, parece que a não temos essa quantidade :/", JOptionPane.WARNING_MESSAGE);
            ...
            EditarComanda.adicionarProduto(Produto,quantidade);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaAddEditComanda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
